...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.458d50029fd930a1d5ef8ab9792f863c5a7a991dc1e1b03b8f26a2014ae27b25.js',function(){input.required=false;search();});}
